...
from .const import CONF_DEVICE_ID, DEFAULT_PORT, DEFAULT_SCAN_INTERVAL, DEFAULT_DEVICE_ID, DOMAIN
...
class OptionsFlowHandler(config_entries.OptionsFlow):
    ...
    async def async_step_init(
        ...
        return self.async_show_form(
            ...
            # TODO APPLY self._config_entry.data.get(CONF_SCAN_INTERVAL, DEFAULT_SCAN_INTERVAL)
        )
